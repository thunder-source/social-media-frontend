          ...
          {post.mediaUrl && post.mediaType && (
            <div className="w-full">
              {post.mediaType === 'image' ? (
                <div
                  className="relative w-full aspect-video cursor-pointer hover:opacity-95 transition-opacity"
                  onClick={() => openLightbox(post.mediaUrl!, "Post attachment")}
                >
                  <Image
                    src={post.mediaUrl}
                    alt="Post attachment"
          ...
          {!post.mediaUrl && post.attachments && post.attachments.length > 0 && (
            <div className="w-full">
              {post.attachments.map((attachment, index) => (
                <div key={attachment.id || index} className="w-full">
                  {attachment.type === 'image' ? (
                    <div
                      className="relative w-full aspect-video cursor-pointer hover:opacity-95 transition-opacity"
                      onClick={() => openLightbox(attachment.url, "Post attachment")}
                    >
                      <Image
                        src={attachment.url}
                        alt="Post attachment"
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="space-y-4">
                  {post.comments?.map((comment, index) => {
                    ...
                    return (
                      <div key={comment.id || comment._id || index} className="flex gap-3 group">
